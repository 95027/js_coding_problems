...
//     customer: "Sai",
//     products: [
//       { id: 101, name: "Laptop", qty: 1 },
//       { id: 102, name: "Mouse", qty: 2 },
//     ],
//   },
//   {
//     id: 2,
//     customer: "Ram",
//     products: [{ id: 103, name: "Keyboard", qty: 1 }],
//   },
// ];

// const res = orders.reduce((acc, val) => {
//   acc.orders = acc.orders || {};
//   acc.products = acc.products || {};

//   acc.orders[val.id] = { customer: val.customer, id: val.id };

//   val.products.forEach((p) => {
//     acc.products[p.id] = { ...p, orderId: val.id };
//   });
...
const res = employees.reduce((acc, val) => {
  acc[val.dept] = acc[val.dept] || {};
  acc[val.dept][val.role] = (acc[val.dept][val.role] || 0) + 1;
  return acc;
}, {});
